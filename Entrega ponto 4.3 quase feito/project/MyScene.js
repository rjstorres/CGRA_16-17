...
MyScene.prototype.rotateSubmarine = function(angle){
    console.log("Myscene, Setting Angle");
	//this.submarine.setAngle(angle);
}

MyScene.prototype.setAcceleration = function(acceleration){
    console.log("Myscene, Setting acceleration");
