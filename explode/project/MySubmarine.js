...
MySubmarine.prototype.checkColision = function(t){
	...
	if(((8-this.xpos-this.xtorp)<=16.5)&&(8-this.xpos-this.xtorp>=13)&&(12-1.6-this.zpos-this.ztorp<=16)&&(12-1.6-this.zpos-this.ztorp>=13)&&(3+this.ypos-1.5<2)){
		this.scene.target2.explode();
		this.resetvars();
	}
	if(((8-this.xpos-this.xtorp)<=3)&&(8-this.xpos-this.xtorp>=0)&&(12-1.6-this.zpos-this.ztorp<=3)&&(12-1.6-this.zpos-this.ztorp>=0)&&(3+this.ypos-1.5<2)){
		this.scene.target1.explode();
		this.resetvars();
	}
	if(((8-this.xpos-this.xtorp)<=16.5)&&(8-this.xpos-this.xtorp>=13)&&(12-1.6-this.zpos-this.ztorp<=7)&&(12-1.6-this.zpos-this.ztorp>=3)&&(3+this.ypos-1.5<2)){
		this.scene.target3.explode();
		this.resetvars();
	}
}
